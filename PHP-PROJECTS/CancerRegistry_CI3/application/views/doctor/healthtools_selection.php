...
<div class="container">
    ...
    <div class="container mt-2">
        ...
        <?php if($CI->session->userdata('rolecode') == MEDICPRAC){ ?>
            <a href="<?php echo base_url('health_tools_assessments'); ?>" class="back-link">
        <?php }else{ ?>
            ...
            <div class="screening-info-container">
                <div class="form">
                    ...
                    <select class="form-select" name="assessment_type_id" aria-label="Default select example" id="">
                        ...
                        <option value="2">Health Tools</option>
...
$("#assessment_form").submit(function(e){
 ...
 function validate_selection_form(){
        ...
        document.getElementById('assessment_form').setAttribute('action', '<?php echo base_url('health_tools/screening') ?>');
