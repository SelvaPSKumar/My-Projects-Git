...
<div class="container">
    ...
    <div class="container mt-2">
        ...
        <?php if($CI->session->userdata('rolecode') == MEDICPRAC){ ?>
            <a href="<?php echo base_url('all_assessments/colorectal_cancer'); ?>" class="back-link">
        <?php }else{ ?>
    ...
    <div class="container">
        <form method="POST" id="assessment_form" action="<?php echo base_url('colorectal_cancer_questions'); ?>">
            <input type="hidden" name="assessment_type_id" value="1">
