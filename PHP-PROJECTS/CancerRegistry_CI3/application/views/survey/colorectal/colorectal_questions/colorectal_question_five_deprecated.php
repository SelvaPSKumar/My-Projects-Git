<div class="container">
    ...
    <div class="question-container mt-5">
        ...
        <form action="<?php echo base_url('colorectal_questions/consult_doctor'); ?>" method="POST">
            <div class="questions-section mt-5">
                <div class="row">
                    <div class="col-md-8 mb-2">
                        <h6>5. Do you have constant abdominal discomfort like cramps, pain or bloating for a while?</h6>
                        <p>Please tick Yes or No</p>
                        <div class="yes-no-section">
                            <div class=" mb-2">
                                <input class="" type="radio" name="5" value="y" id="flexRadioDefault1">
                                <label class="" for="flexRadioDefault1">
                                  Yes
                                </label>
                              </div>
                              <div class=" mb-2">
                                <input class="" type="radio"  name="5" value="n" id="flexRadioDefault2" checked>
        ...
        <!-- <div class="questions-section mt-5">
            <div class="row">
                <div class="col-md-8 mb-2">
                    <h6>5 Do you have constant abdominal discomfort like cramps, pain or bloating for a while?
                    </h6>
                    <p>Please tick Yes or No</p>
                    <div class="yes-no-section">
            ...
            <div class="col-md-4">
                <a href="<?php echo base_url('colorectal_questions/consult_doctor'); ?>">
