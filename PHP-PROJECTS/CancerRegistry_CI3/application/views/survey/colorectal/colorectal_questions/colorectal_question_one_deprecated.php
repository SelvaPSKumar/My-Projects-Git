<div class="container">
    ...
    <div class="question-container mt-5">
        ...
        <hr />
        <form action="<?php echo base_url('colorectal_questions/two'); ?>" method="POST">
            <div class="questions-section mt-5">
                <div class="row">
                    <div class="col-md-8 mb-2">
                        <h6>1. Do you have blood in your stool?</h6>
                        <p>Please tick Yes or No</p>
                        <div class="yes-no-section">
                            <div class=" mb-2">
                                <input class="" type="radio" name="1" value="y" id="flexRadioDefault1">
                                <label class="" for="flexRadioDefault1">
                                  Yes
                                </label>
                              </div>
                              <div class=" mb-2">
                                <input class="" type="radio"  name="1" value="n" id="flexRadioDefault2" checked>
