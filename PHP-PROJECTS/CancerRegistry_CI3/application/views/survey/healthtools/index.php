...
<?php $CI = & get_instance(); ?>
<div class="container">
        <h1 class="screeningHeader">Your Health Tools</h1>
    </div>
    <div class="container mt-2">
        ...
        <?php }else{ ?>
            <a href="<?php echo base_url('test_results/healthtools'); ?>" class="back-link">
        <?php } ?>
    ...
    <div class="container">
        <form method="POST" id="assessment_form" action="<?php echo base_url('your_health_tools') ?>">
            ...
            <input type="hidden" name="literacy_info_proceed" value="false">  
                        ...
                        <div class="card mb-4">
                            <div class="card-body mb-4">
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        <h6 class="mt-2 mx-3">Family History Assessment</h6>
                                    </div>
                                </div>
                            ...
                            <div class="card-footer text-center bg-white p-0">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="assessment_tool_id" id="cflexRadioDefault1" value="25" checked >
                        ...
                        <div class="card mb-4">
                            <div class="card-body mb-4">
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        <h6 class="mt-2 mx-3">Health Literacy Survey</h6>
                                    </div>
                                </div>
                            ...
                            <div class="card-footer text-center bg-white p-0">
                                <div class="form-check" >
                                    <input class="form-check-input" type="radio" name="assessment_tool_id" id="cflexRadioDefault2" value="26" >
                        ...
                        <div class="card mb-4">
                            <div class="card-body mb-4">
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        <h6 class="mt-2 mx-3">Cancer Risk Assessment</h6>
                                    </div>
                                </div>
                            ...
                            <div class="card-footer text-center bg-white p-0">
                                <div class="form-check" >
                                    <input class="form-check-input" type="radio" name="assessment_tool_id" id="cflexRadioDefault3" value="27" >
...
$("#assessment_form").submit(function(e){
 ...
 function validate_selection_form(){
    ...
    document.getElementById('assessment_time').value = currentTime.toISOString().substring(11, 16);
    ...
    function onChangeAssessmentTime() {
        ...
        if (userDate > currentDateTime) {
            ...
            $('#assessment_time').val(currentDateTime.toISOString().substring(11, 16));
        }
    }
