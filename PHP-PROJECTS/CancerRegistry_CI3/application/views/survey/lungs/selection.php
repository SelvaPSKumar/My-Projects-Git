...
<?php $CI = & get_instance(); ?>
<div class="container">
        <h1 class="screeningHeader">Lung Cancer Screening</h1>
    </div>
    <div class="container mt-2">
        <div class="back-container d-flex">
        <?php if($CI->session->userdata('rolecode') == MEDICPRAC){ ?>
            <a href="<?php echo base_url('all_assessments/lung_cancer'); ?>" class="back-link">
        <?php }else{ ?>
    ...
    <div class="container">
        <form method="POST" id="assessment_form" action="<?php echo base_url('lungs_cancer/save_lungs_cancer_header'); ?>">
            <input type="hidden" name="assessment_type_id" value="3">
