...
<?php
if($assessment_tools_id == 11) {
    echo '
    <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.9.4/Chart.js"></script>
    <script src="'.base_url('assets/js/lung_cancer_smokerlyzer.js').'"></script>';   
} elseif( $assessment_tools_id == 10 || $assessment_tools_id == 12 ) {
    echo '
    <script src="'.base_url('assets/js/lung_cancer_LDCT.js').'"></script>';
}
?>
<style>
    .question {
...
$total_group = $questions[count($questions)-1]->group;
 ...
 echo '<input type="hidden" id="adult_or_adolescent" value="'.$patient_adult_or_adolescent.'" />';
?>
<div class="container">
        <div class="back-container">
            <a href="<?php echo base_url('lungs_cancer/screening'); ?>">
            <button class="btn next-btn float-end"><span class="prev-icon"><ion-icon name="chevron-back-outline"></ion-icon></span> Back</button>

            </a>
        </div>
        
        <h1 class="screeningHeader">LUNGS CANCER SCREENING
        </h1>  
    </div>
...
<div class="headernode row">
    ...
    <hr />
           <form name="lungs_cancer_question" id="lungs_cancer_question" action="<?php echo base_url('lungs_cancer/save_lungs_cancer_questions'); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="proceed-footer-general-health group_<?php echo $questions[count($questions)-1]->group; ?>">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <button type="submit" class="btn proceed-btn proceed-btn-lungs_cancer_question">Click to proceed</button>
                </div>
                <div class="col-md-4"></div>
            </div>
            <!-- </a> -->
