...
<?php $CI = & get_instance(); ?>
<div class="container">
        <h1 class="screeningHeader">Prostate Cancer Screening</h1>
    </div>
    <div class="container mt-2">
        <div class="back-container d-flex">
        <?php if($CI->session->userdata('rolecode') == MEDICPRAC){ ?>
            <a href="<?php echo base_url('all_assessments/prostate'); ?>" class="back-link">
        <?php }else{ ?>
    ...
    <div class="container">
        <form method="POST" id="assessment_form" action="<?php echo base_url('prostate_cancer/save_prostate_cancer_header'); ?>">
            <input type="hidden" name="assessment_type_id" value="4">
