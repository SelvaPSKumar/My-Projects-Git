  ...
  div.dataTables_wrapper div.dataTables_length select{
    ...
    <div class="container">
                ...
                <div class="col-md-4">
                    <div class="mt-3">
                        <div class="d-flex justify-content-end">
                            ...
                            <a href="<?php echo base_url('facility/facilityadmin'); ?>">
                            <Button>New Faciity Admin</Button>
                        </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="tabel-results table-responsive">
            ...
            <table id="example" class="table table-borderless">
                <thead>
                  <tr>
                    <th scope="col">Facility Admin Name</th>
               ...
               <tbody>
                  ...
                  ?>
                          <tr onclick="gotoresults('<?php echo $header_id ?>');"> 
                              ...
                              <td><?php echo $result->is_obsolete==false? "yes":"no" ; ?></td> 
    ...
    <script>
      function gotoresults(header_id){
        window.location = "<?php echo base_url('facility/adminfacility/'); ?>" + header_id;
      }
    </script>
    <script>
